...
static const char *fonts[]          = { "JetBrains Mono Nerd Font:style=Bold:size=12:antialias=true:autohint=true", "JoyPixels:size=10:antialias=true:autohint=true" }; 
...
const char *spcmd2[] = {"/opt/piavpn/bin/pia-client", NULL };
...
static const Rule rules[] = {
	...
	{ NULL,	      "pia-client", NULL,	  SPTAG(1),		0,             1,			-1 },
...
/*	{ MODKEY|Mod4Mask,              XK_i,      incrigaps,      {.i = +1 } },
	...
	{ MODKEY|ShiftMask,             XK_i,      setlayout,      {.v = &layouts[11]} }, /*Centered Master*/
